...
In this experiment, data on double halide perovskites will be used to predict the crystal's bandgap using various machine learning models, where feature selection will be used to identify features with high correlation to the bandgap and be applied in training the model.
